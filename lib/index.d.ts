...
declare const init: (configData: Superlogin.IUserConfig, passport?: PassportStatic, userDB?: PouchDB.Database<Superlogin.IUserDoc>, couchAuthDB?: PouchDB.Database<{}>) => Promise<Superlogin.ISLInstance>;
export default init;
