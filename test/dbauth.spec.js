  ...
  it('should delete all expired keys', function() {
    ...
    return previous
      .then(function() {
        ...
        // Store the keys
        promises.push(
          dbAuth.storeKey('testuser1', 'oldkey1', 'password', user1.session.oldkey1.expires)
        )
        promises.push(
          dbAuth.storeKey('testuser1', 'goodkey1', 'password', user1.session.goodkey1.expires)
        )
        promises.push(
          dbAuth.storeKey('testuser2', 'oldkey2', 'password', user2.session.oldkey2.expires)
        )
        promises.push(
          dbAuth.storeKey('testuser2', 'goodkey2', 'password', user2.session.goodkey2.expires)
        )
